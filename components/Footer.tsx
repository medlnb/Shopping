...
function Footer() {
  return (
    <footer className="flex justify-between flex-col md:flex-row flex-wrap gap-4 mx-auto max-w-[50rem] py-20">
      <section>
        <h1 className="text-lg font-bold mb-4">Acount</h1>
      ...
      <section>
        ...
        <ul>
          ...
          <li className="flex items-center gap-2 mb-2 ">
            ...
            <p className="text-gray-600 text-sm">(+965) 7492-3477</p>
          </li>
          <li className="flex items-center gap-2 mb-2 ">
            <CiMail fill="#386cf8" />
      ...
      <section>
        <h1 className="text-lg font-bold mb-4">Quick Link</h1>
        <ul className="text-gray-600 text-sm">
          <li className="mb-2 hover:text-[#386cf8] duration-150">
